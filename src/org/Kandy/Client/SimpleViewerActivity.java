...
//			socket.close();
	...
	public void onSwipe(int direction) {
		...
		new Thread(){ 
			...
			toast(str+" "+read);
//			toast.makeText(this, str+" "+read, Toast.LENGTH_SHORT);
		...
		public void startUpdate(View arg0) {
			...
			new Thread(){ 
				public void run() {	
					if(variables[2] == 1){
						if(mTts!=null)
							mTts.speak(whichView, TextToSpeech.QUEUE_FLUSH, myHashRender);
						else
